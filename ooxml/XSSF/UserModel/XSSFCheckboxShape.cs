...
namespace NPOI.XSSF.UserModel
{
     ...
     */
    public class XSSFCheckboxShape : XSSFShape, IEnumerable<XSSFTextParagraph>
    { // TODO - instantiable superclass
        ...
        protected internal XSSFCheckboxShape(XSSFDrawing Drawing, CT_Shape ctShape)
        {
        ...
        protected internal static CT_Shape GetPrototype()
        {
            if (prototype == null)
            {
                ...
                nvp.id = (/*setter*/1);//TODO: use id from sheet.xml and vmlDrawing.vml
                nvp.name = (/*setter*/"Checkbox 1");
                nv.AddNewCNvSpPr();
                nv.cNvPr.hidden = true;
                nv.cNvPr.extLst = new CT_OfficeArtExtensionList
                {
                    ext = new List<CT_OfficeArtExtension>
                    {
                        new CT_OfficeArtExtension{
                            uri = "{63B3BB69-23CF-44E3-9099-C40C66FF867C}",
                            Any = "<a14:compatExt spid=\"_x0000_s" + nvp.id + "\"/>",
                        },
                    },
                };
                ...
                sp.bwMode = ST_BlackWhiteMode.auto;
                ...
                sp.noFill = new CT_NoFillProperties();
                sp.ln = new CT_LineProperties();
                sp.ln.noFill = new CT_NoFillProperties();

                sp.extLst = new CT_OfficeArtExtensionList
                {
                    ext = new List<CT_OfficeArtExtension>
                    {
                        new CT_OfficeArtExtension {
                ...
                bodypr.vertOverflow = ST_TextVertOverflowType.clip;
                bodypr.wrap = ST_TextWrappingType.square;
                ...
                CT_TextParagraphProperties ppr = p.AddNewPPr();
                ppr.algn = ST_TextAlignType.l;
                ppr.defRPr = new CT_TextCharacterProperties
                {
                    sz = 1000,
                };
